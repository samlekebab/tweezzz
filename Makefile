...
wavetest:
	g++ -fext-numeric-literals -std=c++20 -O2 -ftree-vectorize waitTimeEvent.cpp timeEvent.cpp waveTest.cpp core.cpp coregpu.cpp aom.cpp aom1D.cpp aom2D.cpp scheduler.cpp formGenerator.cpp tweezer.cpp tas.cpp mmath.cpp -o wavetest.out -pg -lOpenCL -Wall
withOptiInfo:
